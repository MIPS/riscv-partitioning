...
will see in the diagrams of <<smwidd>> and <<smwidv>>, the addition of this
"higher than M-mode" privilege level allows a constraints-based view of the
privilege levels to extend from the hart to beyond-the-hart - constraining
M-mode in the process.
