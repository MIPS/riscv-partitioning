= non-existant TG Specifications

This repository is for specification deliverables of the non-existant TG per the proposed link:charter.adoc[charter]. The specification(s) are not ratified and everything in these documents may change.
